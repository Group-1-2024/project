<template>
  <div class="flex items-center justify-between mb-[4vw] pt-[4vw]">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
      viewBox="0 0 24 24"
      class="size-[8vw] rotate-90 font-thin"
      @click="drawer = true"
    >
      <path
        fill="black"
        d="M6.5 20q-.625 0-1.062-.437T5 18.5v-3q0-.625.438-1.062T6.5 14t1.063.438T8 15.5v3q0 .625-.437 1.063T6.5 20m6 0q-.625 0-1.062-.437T11 18.5v-8q0-.625.438-1.062T12.5 9t1.063.438T14 10.5v8q0 .625-.437 1.063T12.5 20m6 0q-.625 0-1.062-.437T17 18.5v-13q0-.625.438-1.062T18.5 4t1.063.438T20 5.5v13q0 .625-.437 1.063T18.5 20"
      />
    </svg>
    ...
    <div class="relative">
      <label for="">
        <input
          type="text"
          class="dark:from-[#34304b] dark:to-[#403246] dark:border-0 text-[4vw] pl-[8vw] bg-gradient-to-r from-[#d9ddfd] text-[#8189A1] to-[#f3d9ef] opacity-0.2 w-[75vw] h-[10vw] border-2 border-[#CCCEF7] rounded-[25px]"
          placeholder="❤离别开出花-就是南方..."
        />
        <svg
          class="absolute left-[2.5vw] top-[2vw] w-[6vw] h-[6vw] text-[#8189A1] iconify iconify--tabler"
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
          viewBox="0 0 50 50"
        ...
        <svg
          class="absolute right-[4vw] top-[2.5vw] w-[5vw] h-[5vw] text-[#8189A1] iconify iconify--tabler"
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
          viewBox="0 0 24 24"
  ...
  <el-drawer
    ...
    direction="ltr"
    size="85%"
    :style="{ backgroundColor: dark ? '#141414' : '#f1f1f1' }"
  >
    <div>
      <div class="flex justify-between items-center h-[14vw]">
        <div class="flex items-center w-[30vw] justify-around">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            height="1em"
            viewBox="0 0 24 24"
            class="text-[#f9dada] w-[7vw] h-[7vw] iconify iconify--gridicons bg-[#f1f1f1] rounded-[50%]"
            _mstVisible="6"
          >
            <path
              fill="currentColor"
          ...
          <div class="text-[3.5vw]" @click="tologin">立刻登陆</div>
          <Icon
            icon="lets-icons:expand-right"
            width="16"
            height="16"
            class="dark:text-[#f0f0f0] text-[#333]"
          />
        </div>
        <div>
          <Icon
      ...
      <div>
        <div
          class="w-[76vw] h-[27.66vw] bg-gradient-to-r from-[#3b3b3b] to-[#5f5050] rounded-[20px] p-[2vw]"
        >
          <div class="flex h-[10vw] justify-between items-center">
            <h1 class="text-[#ffeeeb] text-[3.6vw]">开通黑胶VIP</h1>
            <div
              class="w-[15vw] h-[6vw] text-[2.5vw] border-[1px] text-[#9e8f8f] border-[solid] border-[#9e8f8f] rounded-[20px] leading-[6vw] text-center"
            >
              会员中心
            </div>
          </div>
          <div class="h-[6vw] text-[2.5vw] text-[#9e8f8f]">
            点击恢复超21项专属特权
          </div>
          <div
            class="h-[10vw] text-[2.5vw] text-[#9e8f8f] flex justify-between items-center"
          >
            <div>受邀专享，黑胶VIP低至0.27元/天！</div>
            <div class="scale-50 w-[13vw]">
              <div
        ...
        <div
          class="dark:bg-[#2c2c2c] bg-[#fff] rounded-[15px] w-[76vw] mx-auto mt-[4vw]"
        >
          <div class="px-[4vw]">
                  ...
                  <g fill="currentColor" fill-opacity="0">
                    ...
                    >
                      <animate
                        ...
                        begin="0.7s;iconifyVue0.begin+6s"
                        dur="0.4s"
                        values="0;1"
                      ></animate>
                      <animate
...
// bug2:switch开关的chang刷新后恢复默认，不跟随模式的改变而改变
</script>
